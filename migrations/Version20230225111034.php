 ...
 */
final class Version20230225111034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pregunta (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, producto_id INT NOT NULL, nombre_autor VARCHAR(400) NOT NULL, texto VARCHAR(1000) DEFAULT NULL, fecha DATETIME DEFAULT NULL, INDEX IDX_AEE0E1F7A76ED395 (user_id), INDEX IDX_AEE0E1F77645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE respuesta (id INT AUTO_INCREMENT NOT NULL, pregunta_id INT NOT NULL, user_id INT DEFAULT NULL, texto VARCHAR(1000) DEFAULT NULL, nombre_autor VARCHAR(500) DEFAULT NULL, fecha DATETIME DEFAULT NULL, INDEX IDX_6C6EC5EE31A5801E (pregunta_id), INDEX IDX_6C6EC5EEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
